...
function New-LWStoryAchievementFlags {
    ...
    return [pscustomobject]@{
        ...
        Book6Section016MapClaimed   = $false
        Book6CessPurchasePaid       = $false
        ...
        Book6Section165MapPaid      = $false
        Book6Section207Handled   = $false
        Book6Section209ArrowLost = $false
...
function Rebuild-LWStoryAchievementFlagsFromState {
    ...
    if ([int]$script:GameState.Character.BookNumber -ge 6) {
        ...
        if ($visitedSections -contains 209) { Set-LWStoryAchievementFlag -Name 'Book6Section209ArrowLost' }
