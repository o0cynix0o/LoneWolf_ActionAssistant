...
1. continuing M6 web GUI parity work: remaining structured prompt edge cases, achievement/book-automation/browser-DOM parity harnesses, cross-platform launch/packaging hardening, and web-first release docs
...
- continue M6 parity work from the browser scaffold, especially achievement, book-automation, and browser-DOM flow validation plus cross-platform hardening
